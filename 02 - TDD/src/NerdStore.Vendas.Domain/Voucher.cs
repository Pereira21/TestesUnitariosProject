...
namespace NerdStore.Vendas.Domain
{
    ...
    {
        public Voucher(string codigo, decimal? percentualDesconto, decimal? valorDesconto, int quantidade, ETipoDescontoVoucher tipoDescontoVoucher, DateTime dataValidade, bool ativo, bool utilizado)
        {
            Codigo = codigo;
    ...
    public class VoucherAplicavelValidation : AbstractValidator<Voucher>
    {
        ...
        public VoucherAplicavelValidation()
        {
            ...
            When(f => f.TipoDescontoVoucher == ETipoDescontoVoucher.Porcentagem, () =>
            {
