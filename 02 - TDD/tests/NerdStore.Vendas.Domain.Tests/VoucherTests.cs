...
namespace NerdStore.Vendas.Domain.Tests
{
    public class VoucherTests
    {
        ...
        {
            //Arrange
            var voucher = new Voucher("", null, null, 0, ETipoDescontoVoucher.Valor, DateTime.Now.AddDays(-1), false, true);
        ...
        {
            //Arrange
            var voucher = new Voucher("PROMO-15-OFF", 15, null, 1, ETipoDescontoVoucher.Porcentagem, DateTime.Now.AddDays(15), true, false);
        ...
        {
            //Arrange
            var voucher = new Voucher("", null, null, 0, ETipoDescontoVoucher.Porcentagem, DateTime.Now.AddDays(-1), false, true);
